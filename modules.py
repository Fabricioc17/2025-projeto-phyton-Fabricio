'''
Arquivo e funções utilizadas 
2025.06.25
Fabricio
'''
#Objetivo: Criar um arquivoe funções que serão utilizadas em nossos Projetos

#BIBLIOTECAS
from random import randint #importar a função randint da biblioteca


#CONSTANTES
TAM = int(50) #tamanho da tela
MAR = int(2) #margem da mg da tela
